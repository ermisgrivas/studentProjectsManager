...
--
-- Host: localhost    Database: tech_log
-- ------------------------------------------------------
...
CREATE DATABASE IF NOT EXISTS tech_log;
USE tech_log;
...
CREATE TABLE `message` (
  ...
  KEY `email_idx` (`email`),
  CONSTRAINT `email` FOREIGN KEY (`email`) REFERENCES `student` (`email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `student_team` (
  ...
  CONSTRAINT `am` FOREIGN KEY (`am`) REFERENCES `student` (`am`),
...
-- Dump completed on 2026-06-05  1:17:31
